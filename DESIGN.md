# stellarengine design

## Table of Contents

- [stellarengine design](#stellarengine-design)
...
`stellarengine` is designed to be template to instantly get started with Multi-Cloud Serverless Apps.

## How is it different from what I already use?

**WORK IN PROGRESS**: `stellarengine` is still in the `design` phase.
...
`stellarengine` is a part of the [Open Source Universe](https://github.com/intellibus/approach). All Projects in the [Open Source Universe](https://github.com/intellibus/approach) follow the same [Contribution Guidelines & Process](https://github.com/intellibus/approach).
...
`stellarengine` only plans to initially support Typescript & JavaScript Applications. However, we would love for the community to contribute versions for other languages (Java, Go, etc.)
